...
print('Model 2, Construct Features~')
...
print('Model 2, Start LGBM Classifier~')
lgb_model = lgb.LGBMClassifier(boosting_type='gbdt', num_leaves=100, reg_alpha=3, reg_lambda=5, max_depth=-1,
	...
	random_state=1000, n_jobs=4, min_child_weight=4, min_child_samples=5, min_split_gain=0)
...
sub.to_csv(result_path + 'model2_res.csv',index=0)

print('Model 2, Process Done~')