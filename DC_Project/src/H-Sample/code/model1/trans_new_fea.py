...
hour_bin = {
	...
	12:3, 13:3, 14:4, 15:4, 16:4, 17:4, 18:5, 19:5, 20:5, 21:5, 22:5, 23:0
}
...
def get_trans_new_feature():
	...
	trans_unstack_feature = get_trans_unstack_feature(trans_data)
	
	trans_intersection_topK_feature = get_trans_intersection_topK_feature()
